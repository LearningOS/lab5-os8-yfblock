...
use crate::config::{DEADLOCK_WORK_M, DEADLOCK_WORK_N, KERNEL_STACK_SIZE, PAGE_SIZE, TRAMPOLINE, TRAP_CONTEXT, USER_STACK_SIZE};
...
pub struct DeadlockDetectInfo {
    pub deadlock_allocation: [[u32; DEADLOCK_WORK_M]; DEADLOCK_WORK_N],
    pub deadlock_need: Option<(u32, u32, u32)>, // 被阻塞的原因，是因为需要（资源类型、资源ID、资源数量）
}
