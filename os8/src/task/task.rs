...
use crate::task::id::DeadlockDetectInfo;
...
pub struct TaskControlBlockInner {
    ...
    pub deadlock_info: DeadlockDetectInfo
}
        ...
        Self {
            ...
            inner: unsafe {
                UPSafeCell::new(TaskControlBlockInner {
                    ...
                    exit_code: None,
                    deadlock_info: DeadlockDetectInfo {
                        deadlock_allocation: [[0; DEADLOCK_WORK_M]; DEADLOCK_WORK_N],
                        deadlock_need: None
                    }
                })
            },
